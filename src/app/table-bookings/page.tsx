...
export default function TableBookingsPage() {
  ...
  const pending = useMemo(() => upcoming.filter((reservation) => reservation.status === "pending"), [upcoming]);
  const declined = useMemo(() => upcoming.filter((reservation) => reservation.status === "rejected"), [upcoming]);
