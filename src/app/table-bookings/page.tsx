...
export default function TableBookingsPage() {
  ...
  const durationOptions = data?.isSuper ? [30, 60, 90, 120, 150, 180, 240] : selectedTable?.sport_type === "snooker" ? [30, 60] : [30];
