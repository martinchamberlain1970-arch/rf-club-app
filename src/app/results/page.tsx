            ...
            <>
              ...
              {admin.isSuper && deadlineFixtures.length ? (
                <section className="rounded-3xl border-2 border-amber-300 bg-amber-50 p-5 shadow-sm">
                  ...
                  <p className="mt-1 text-sm text-amber-900">These fixtures passed their competition&apos;s Sunday deadline without an approved result. You can accept a sole submission without chasing the opponent, enter the result yourself, award a genuine no-show result or walkover using that competition&apos;s format, or void the fixture.</p>
                  <div className="mt-4 space-y-3">
