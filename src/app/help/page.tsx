...
const faqs: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer:
      "Valid approved snooker singles results update Elo. Every four weeks the app recalculates each handicap directly from current club Elo, with no limit on movement up or down, and applies it immediately to every unplayed fixture. The Super User can also recalculate one new player or everyone manually.",
  },
  {
  ...
  player: {
    ...
    rankings: {
      ...
      bullets: [
        ...
        "Snooker handicap is recalculated directly from Elo every four weeks, with no movement limit, and applies immediately to every unplayed fixture. The Super User can also recalculate a selected new player or everyone manually.",
