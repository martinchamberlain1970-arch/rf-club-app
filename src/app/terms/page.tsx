    ...
    <main className="min-h-screen bg-slate-100 p-6">
      <div className="mx-auto max-w-3xl space-y-4 rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
        ...
        <ul className="list-disc space-y-1 pl-5 text-slate-700">
          ...
          <li>After the weekly deadline, unresolved fixtures are decided by the Super User. A sole submitted result may be accepted; a genuine no-show may be awarded according to that competition&apos;s match format; otherwise the fixture may be voided with no points awarded.</li>
